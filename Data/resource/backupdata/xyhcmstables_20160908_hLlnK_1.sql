...
CREATE TABLE `xyh_category` (
  ...
  PRIMARY KEY (`id`),
  KEY `pid` (`pid`)
) ENGINE=MyISAM AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='栏目分类表' ;
...
INSERT INTO `xyh_abc` VALUES ('3','首页宗旨','首页宗旨','0','0','<loop>{$content}</loop>','1','5','3');
INSERT INTO `xyh_abc` VALUES ('4','代言人','','0','0','<loop><a href=\"{$url}\"><img src=\"{$content}\" /></a></loop>','2','5','2');
...
INSERT INTO `xyh_abc_detail` VALUES ('5','1','以最真诚、最专业、最用心的教育咨询服务为宗旨','','1473172791','1475764791','3','1','1');
INSERT INTO `xyh_abc_detail` VALUES ('6','2','以最真诚、最专业、最用心的教育咨询服务为宗旨','','1473172802','1475764802','3','1','1');
INSERT INTO `xyh_abc_detail` VALUES ('7','3','以最真诚、最专业、最用心的教育咨询服务为宗旨','','1473172807','1475764807','3','1','1');
INSERT INTO `xyh_abc_detail` VALUES ('8','翁婕菀','/uploads/abc1/20160906/57ced614bb65a.jpg','','1473172978','1917096120','4','1','1');
INSERT INTO `xyh_abc_detail` VALUES ('9','许玺铎','/uploads/abc1/20160906/57ced6281e848.jpg','','1473173018','1980254580','4','1','1');
...
# 转存表中的数据：xyh_admin 
INSERT INTO `xyh_admin` VALUES ('1','admin','5d4637abd8e6c1aecc9b7cae407705d6','2MFI8s','','','9','1473260105','127.0.0.1','0');


# 转存表中的数据：xyh_announce 
INSERT INTO `xyh_announce` VALUES ('1','恭喜“思行”网站隆重上线，现在咨询预约可享95折，学员可享最好等优惠，还等什么快来咨询吧！','<p>恭喜“思行”网站隆重上线，现在咨询预约可享95折，学员可享最好等优惠，还等什么快来咨询吧！</p>','0','1901234160','1','1396399014');
...
INSERT INTO `xyh_article` VALUES ('17','外国英语老师','','','','','','','<p><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">1) 大专及以上学历，语言类相关专业，文科；</span><br style=\"word-wrap: break-word; outline: none; color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">2) 听说读写熟练，普通话标准；最好掌握一门第二外语，例如英语；&nbsp;</span><br style=\"word-wrap: break-word; outline: none; color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">3) 热爱学习，执着教学，具有亲和力，愿投身教育事业；&nbsp;</span><br style=\"word-wrap: break-word; outline: none; color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">4) 良好的沟通能力和组织能力。</span><br style=\"word-wrap: break-word; outline: none; color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">5) 性格外向，因为外国人喜欢活泼的老师&nbsp;</span><br style=\"word-wrap: break-word; outline: none; color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">6) 完成目标教学任务，按教学进度对每位外籍学员的实际学习情况给出评价；</span><br style=\"word-wrap: break-word; outline: none; color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">* 参加中心定期教学经验交流活动，在教学水平上积极进取和提高；</span></p>','1) 大专及以上学历，语言类相关专业，文科；2) 听说读写熟练，普通话标准；最好掌握一门第二外语，例如英语；&nbsp;3) 热爱学习，执着教学，具有亲和力，愿投身教育事业；&nbsp;4) 良好的沟通能力和组织能力。5) 性格外向，因为外','1473260650','1473260681','59','13','0','0','','0','0','1');
INSERT INTO `xyh_article` VALUES ('18','初中英语老师','','','','','','','<p><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">1) 大专及以上学历，语言类相关专业，文科；</span><br style=\"word-wrap: break-word; outline: none; color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">2) 听说读写熟练，普通话标准；最好掌握一门第二外语，例如英语；&nbsp;</span><br style=\"word-wrap: break-word; outline: none; color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">3) 热爱学习，执着教学，具有亲和力，愿投身教育事业；&nbsp;</span><br style=\"word-wrap: break-word; outline: none; color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">4) 良好的沟通能力和组织能力。</span><br style=\"word-wrap: break-word; outline: none; color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">5) 性格外向，因为外国人喜欢活泼的老师&nbsp;</span><br style=\"word-wrap: break-word; outline: none; color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">6) 完成目标教学任务，按教学进度对每位外籍学员的实际学习情况给出评价；</span><br style=\"word-wrap: break-word; outline: none; color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">* 参加中心定期教学经验交流活动，在教学水平上积极进取和提高；</span></p>','1) 大专及以上学历，语言类相关专业，文科；2) 听说读写熟练，普通话标准；最好掌握一门第二外语，例如英语；&nbsp;3) 热爱学习，执着教学，具有亲和力，愿投身教育事业；&nbsp;4) 良好的沟通能力和组织能力。5) 性格外向，因为外','1473260781','1473260792','51','13','1','0','','0','0','1');
INSERT INTO `xyh_article` VALUES ('19','高中语文老师','','','','','','','<p><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">1) 大专及以上学历，语言类相关专业，文科；</span><br style=\"word-wrap: break-word; outline: none; color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">2) 听说读写熟练，普通话标准；最好掌握一门第二外语，例如英语；&nbsp;</span><br style=\"word-wrap: break-word; outline: none; color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">3) 热爱学习，执着教学，具有亲和力，愿投身教育事业；&nbsp;</span><br style=\"word-wrap: break-word; outline: none; color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">4) 良好的沟通能力和组织能力。</span><br style=\"word-wrap: break-word; outline: none; color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">5) 性格外向，因为外国人喜欢活泼的老师&nbsp;</span><br style=\"word-wrap: break-word; outline: none; color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">6) 完成目标教学任务，按教学进度对每位外籍学员的实际学习情况给出评价；</span><br style=\"word-wrap: break-word; outline: none; color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(143, 143, 143); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 35px; background-color: rgb(255, 255, 255);\">* 参加中心定期教学经验交流活动，在教学水平上积极进取和提高；</span></p>','1) 大专及以上学历，语言类相关专业，文科；2) 听说读写熟练，普通话标准；最好掌握一门第二外语，例如英语；&nbsp;3) 热爱学习，执着教学，具有亲和力，愿投身教育事业；&nbsp;4) 良好的沟通能力和组织能力。5) 性格外向，因为外','1473260805','1473260818','46','13','1','0','','0','0','1');
INSERT INTO `xyh_article` VALUES ('20','应试教育和社会功利性导致精神层面的缺失','应试教育和社会功利性导致精神层面的缺失','','','','','','<p><img src=\"http://sixing.cc/Data/editor/ueditor/themes/default/images/spacer.gif\" style=\"background:url(http://sixing.cc/Data/editor/ueditor/lang/zh-cn/images/localimage.png) no-repeat center center;border:1px solid #ddd\" word_img=\"file:///C:/Users/Administrator.608IF0AABT30SJP/Desktop/HTML/images/zqzb.jpg\"/><span style=\"color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; background-color: rgb(255, 255, 255);\">教育过程开始于一个人的出生并持续终身已被广泛接受。有些人甚至认为教育可以开始得更早，一些父母通过外部的言语和音乐来影响子宫里成长着的胎儿，进行胎教，希望给孩子以积极的健康的发展。“教育”一词来源于拉丁语educare，意思是 “引出”。社会根据受教育程度选拔人才。人通过受教育实现社会地位的变迁。教育伴随着人类社会的产生而产生，随着社会的发展而发展，与人类社会共始终。对教育的定义，各国学者认识不同。如美国的杜威说：“教育即生活。”英国的斯宾塞说：“教育为未来生活之准备。”中国的李壮认为“教育是强迫或引导被教育者接受特定的知识、规矩、信息、技能、技巧等。”在西方，教育一词源于拉丁文educate，前缀“e”有“出”的意思，意为“引出”或“导出”，意思就是通过一定的手段，把某种本来潜在于身体和心灵内部的东西引发出来。从词源上说，西方“教育”一词是内发之意。强调教育是一种顺其自然的活动，旨在把自然人所固有的或潜在的素质，自内而外引发出来，以成为现实的发展状态 规矩、信息、技能、技巧等。”&nbsp;</span><br style=\"word-wrap: break-word; outline: none; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\"/><br style=\"word-wrap: break-word; outline: none; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; background-color: rgb(255, 255, 255);\">在西方，教育一词源于拉丁文educate，前缀“e”有“出”的意思，意为“引出”或“导出”，意思就是通过一定的手段，把某种本来潜在于身体和心灵内部的东西引发出来。从词源上说，西方“教育”一词是内发之意。强调教育是一种顺其自然的活动，旨在把自然人所固有的或潜在的素质，自内而外引发出来，以成为现实的发展状态&nbsp;</span><br style=\"word-wrap: break-word; outline: none; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\"/><br style=\"word-wrap: break-word; outline: none; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; background-color: rgb(255, 255, 255);\">电力是以电能作为动力的能源。发明于19世纪70 年代，电力的发明和应用掀起了第二次工业化高潮。成为人类历史18世纪以来，世界发生的三次科技革命之一，从此科技改变了人们的生活。20世纪出现的大规模电力系统是人类工程科学史上最重要的成就之一，是由发电、输电、变电、配电和用电等环节组成的电力生产与消费系统。它将自然界的一次能源通过机械能装置转化成电力，再经输电、变电和配电将电力供应到各用户。</span></p>','教育过程开始于一个人的出生并持续终身已被广泛接受。。。','1473261178','1473261249','73','14','0','0','','0','0','1');
INSERT INTO `xyh_article` VALUES ('21','应试教育和社会功利性导致精神层面的缺失','应试教育和社会功利性导致精神层面的缺失','','','','','','<p><span style=\"color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; background-color: rgb(255, 255, 255);\">教育过程开始于一个人的出生并持续终身已被广泛接受。有些人甚至认为教育可以开始得更早，一些父母通过外部的言语和音乐来影响子宫里成长着的胎儿，进行胎教，希望给孩子以积极的健康的发展。“教育”一词来源于拉丁语educare，意思是 “引出”。社会根据受教育程度选拔人才。人通过受教育实现社会地位的变迁。教育伴随着人类社会的产生而产生，随着社会的发展而发展，与人类社会共始终。对教育的定义，各国学者认识不同。如美国的杜威说：“教育即生活。”英国的斯宾塞说：“教育为未来生活之准备。”中国的李壮认为“教育是强迫或引导被教育者接受特定的知识、规矩、信息、技能、技巧等。”在西方，教育一词源于拉丁文educate，前缀“e”有“出”的意思，意为“引出”或“导出”，意思就是通过一定的手段，把某种本来潜在于身体和心灵内部的东西引发出来。从词源上说，西方“教育”一词是内发之意。强调教育是一种顺其自然的活动，旨在把自然人所固有的或潜在的素质，自内而外引发出来，以成为现实的发展状态 规矩、信息、技能、技巧等。”&nbsp;</span><br style=\"word-wrap: break-word; outline: none; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\"/><br style=\"word-wrap: break-word; outline: none; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; background-color: rgb(255, 255, 255);\">在西方，教育一词源于拉丁文educate，前缀“e”有“出”的意思，意为“引出”或“导出”，意思就是通过一定的手段，把某种本来潜在于身体和心灵内部的东西引发出来。从词源上说，西方“教育”一词是内发之意。强调教育是一种顺其自然的活动，旨在把自然人所固有的或潜在的素质，自内而外引发出来，以成为现实的发展状态&nbsp;</span><br style=\"word-wrap: break-word; outline: none; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\"/><br style=\"word-wrap: break-word; outline: none; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; background-color: rgb(255, 255, 255);\">电力是以电能作为动力的能源。发明于19世纪70 年代，电力的发明和应用掀起了第二次工业化高潮。成为人类历史18世纪以来，世界发生的三次科技革命之一，从此科技改变了人们的生活。20世纪出现的大规模电力系统是人类工程科学史上最重要的成就之一，是由发电、输电、变电、配电和用电等环节组成的电力生产与消费系统。它将自然界的一次能源通过机械能装置转化成电力，再经输电、变电和配电将电力供应到各用户。</span></p>','教育过程开始于一个人的出生并持续终身已被广泛接受。。。','1473261276','1473261306','87','14','1','0','','0','0','1');
INSERT INTO `xyh_article` VALUES ('22','应试教育和社会功利性导致精神层面的缺失','应试教育和社会功利性导致精神层面的缺失','','','','','','<p><span style=\"color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; background-color: rgb(255, 255, 255);\">教育过程开始于一个人的出生并持续终身已被广泛接受。有些人甚至认为教育可以开始得更早，一些父母通过外部的言语和音乐来影响子宫里成长着的胎儿，进行胎教，希望给孩子以积极的健康的发展。“教育”一词来源于拉丁语educare，意思是 “引出”。社会根据受教育程度选拔人才。人通过受教育实现社会地位的变迁。教育伴随着人类社会的产生而产生，随着社会的发展而发展，与人类社会共始终。对教育的定义，各国学者认识不同。如美国的杜威说：“教育即生活。”英国的斯宾塞说：“教育为未来生活之准备。”中国的李壮认为“教育是强迫或引导被教育者接受特定的知识、规矩、信息、技能、技巧等。”在西方，教育一词源于拉丁文educate，前缀“e”有“出”的意思，意为“引出”或“导出”，意思就是通过一定的手段，把某种本来潜在于身体和心灵内部的东西引发出来。从词源上说，西方“教育”一词是内发之意。强调教育是一种顺其自然的活动，旨在把自然人所固有的或潜在的素质，自内而外引发出来，以成为现实的发展状态 规矩、信息、技能、技巧等。”&nbsp;</span><br style=\"word-wrap: break-word; outline: none; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\"/><br style=\"word-wrap: break-word; outline: none; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; background-color: rgb(255, 255, 255);\">在西方，教育一词源于拉丁文educate，前缀“e”有“出”的意思，意为“引出”或“导出”，意思就是通过一定的手段，把某种本来潜在于身体和心灵内部的东西引发出来。从词源上说，西方“教育”一词是内发之意。强调教育是一种顺其自然的活动，旨在把自然人所固有的或潜在的素质，自内而外引发出来，以成为现实的发展状态&nbsp;</span><br style=\"word-wrap: break-word; outline: none; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\"/><br style=\"word-wrap: break-word; outline: none; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; background-color: rgb(255, 255, 255);\">电力是以电能作为动力的能源。发明于19世纪70 年代，电力的发明和应用掀起了第二次工业化高潮。成为人类历史18世纪以来，世界发生的三次科技革命之一，从此科技改变了人们的生活。20世纪出现的大规模电力系统是人类工程科学史上最重要的成就之一，是由发电、输电、变电、配电和用电等环节组成的电力生产与消费系统。它将自然界的一次能源通过机械能装置转化成电力，再经输电、变电和配电将电力供应到各用户。</span></p>','教育过程开始于一个人的出生并持续终身已被广泛接受。。。','1473261414','1473261432','50','14','1','0','','0','0','1');


# 转存表中的数据：xyh_attachment 
INSERT INTO `xyh_attachment` VALUES ('1','bg.jpg','abc1/20160906/57ced2b35fd82.jpg','1','160383','0','1473172147','1','0');
INSERT INTO `xyh_attachment` VALUES ('2','people1.jpg','abc1/20160906/57ced614bb65a.jpg','1','5754','0','1473173012','1','0');
INSERT INTO `xyh_attachment` VALUES ('3','people2.jpg','abc1/20160906/57ced6281e848.jpg','1','6206','0','1473173032','1','0');
INSERT INTO `xyh_attachment` VALUES ('4','people1.jpg','img1/20160906/57ced6c6bd4de.jpg','1','5754','1','1473173190','1','0');
INSERT INTO `xyh_attachment` VALUES ('5','people2.jpg','img1/20160906/57ced84020a9d.jpg','1','6206','1','1473173568','1','0');
INSERT INTO `xyh_attachment` VALUES ('6','people3.jpg','img1/20160906/57ced8676f1a6.jpg','1','4988','1','1473173607','1','0');


# 转存表中的数据：xyh_attachmentindex 
INSERT INTO `xyh_attachmentindex` VALUES ('2','8','0','abc');
INSERT INTO `xyh_attachmentindex` VALUES ('3','9','0','abc');
INSERT INTO `xyh_attachmentindex` VALUES ('4','2','4','');
INSERT INTO `xyh_attachmentindex` VALUES ('5','3','4','');
INSERT INTO `xyh_attachmentindex` VALUES ('5','4','4','');
INSERT INTO `xyh_attachmentindex` VALUES ('6','5','4','');
...
INSERT INTO `xyh_block` VALUES ('2','index_si','首页【思行服务，内容安排】','<div class=\"service_list min-w\">\r\n					<ul>\r\n						<li>\r\n							<div class=\"service_L fl\">A</div>\r\n							<div class=\"service_R fl\">\r\n								<h2>晚间作业辅导</h2>\r\n								<div class=\"clear service_R_down\">\r\n									1 每周一到五，19:00-22:00  进行作业辅导；2 配置专业教师团队坐镇答疑室，及时解惑，提高学习效率；3 提供最舒适的学习环境，采取监控式管理，保障晚辅纪律；\r\n								</div>\r\n							</div>\r\n						</li>\r\n						<li>\r\n							<div class=\"service_L fl\">B</div>\r\n							<div class=\"service_R fl\">\r\n								<h2>毕业班辅导课程</h2>\r\n								<div class=\"clear service_R_down\">\r\n									1 按专题授课，自主选报，每六周一专题；2 采用知识讲解与典例解析课组结合的循环授课模式；3 对基础较弱的学生，建议增加额外小班；\r\n								</div>\r\n							</div>\r\n						</li>\r\n						<li>\r\n							<div class=\"service_L fl\">C</div>\r\n							<div class=\"service_R fl\">\r\n								<h2>非毕业班辅导课程</h2>\r\n								<div class=\"clear service_R_down\">\r\n									1 精致小班，按层次分班教学；2 与学校同步，即时解决学生在校疑点；3 及时反馈学生学习情况，保障学习效果；\r\n								</div>\r\n							</div>\r\n						</li>\r\n						<li>\r\n							<div class=\"service_L fl\">D</div>\r\n							<div class=\"service_R fl\">\r\n								<h2>“私人定制”课程</h2>\r\n								<div class=\"clear service_R_down\">\r\n									1 名师授课，配置最符合学生实际情况的教师；2 为学生量身定制学习方案；3 针对性备课辅导，快速解决学生知识短板;\r\n								</div>\r\n							</div>\r\n						</li>\r\n					</ul>\r\n				</div>','1');


# 转存表中的数据：xyh_category 
INSERT INTO `xyh_category` VALUES ('1','机构介绍','jigoujieshao','','0','2','0','','机构介绍',' 机构介绍','','List_about.html','Show_jobs.html','<p style=\"word-wrap: break-word; outline: none; margin: auto; padding: 0px; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; overflow: hidden; background-color: rgb(255, 255, 255);\">汕头市金平区思行教育机构成立于2014年7月，承接的业务有初高中课程学习咨询、教育管理服务信息咨询、高校招生信息咨询、职业技能教育信息咨询、教育项目合作信息咨询。<br style=\"word-wrap: break-word; outline: none;\"/><br style=\"word-wrap: break-word; outline: none;\"/>汕头市金平区思行教育机构为人才创造机会和为客户创造价值。并以最真诚、最专业、最用心的教育咨询服务为宗旨，站在学员的角度和立场，为每一位相信我们的学员提供走向成功的平台！</p><hr style=\"word-wrap: break-word; outline: none; border-bottom-style: dotted; border-bottom-color: rgb(204, 204, 204); border-top-width: 0px; margin: 30px auto; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\"/><p style=\"word-wrap: break-word; outline: none; margin: auto auto 24px; padding: 0px; font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; white-space: normal; font-size: 32px; color: rgb(68, 68, 68); background-color: rgb(255, 255, 255);\">教学目标</p><p style=\"word-wrap: break-word; outline: none; margin: auto auto 24px; padding: 0px; font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; white-space: normal; font-size: 12px; color: rgb(143, 143, 143); background-color: rgb(255, 255, 255);\">Teaching objectives</p><p style=\"word-wrap: break-word; outline: none; margin: auto; padding: 0px; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\">在考前三个月左右的时间（学生需向学校请假）帮助艺术生高考的六大科目（分文科和理科）（文科：语文/数学/英语/历史/政治/地理）（理科：语文/数学/英语/物理/化学/生物）重要考点系统性进行复习，学习方法，答题技巧和应试技巧学习，帮助艺术生达到自己的目标分数。</p><hr style=\"word-wrap: break-word; outline: none; border-bottom-style: dotted; border-bottom-color: rgb(204, 204, 204); border-top-width: 0px; margin: 30px auto; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\"/><p style=\"word-wrap: break-word; outline: none; margin: auto auto 24px; padding: 0px; font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; white-space: normal; font-size: 32px; color: rgb(68, 68, 68); background-color: rgb(255, 255, 255);\">与专业补习的区别</p><p style=\"word-wrap: break-word; outline: none; margin: auto auto 24px; padding: 0px; font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; white-space: normal; font-size: 12px; color: rgb(143, 143, 143); background-color: rgb(255, 255, 255);\">The difference</p><p style=\"word-wrap: break-word; outline: none; margin: auto; padding: 0px; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\">1.专业全职老师，带过多年的高考艺术生，了解艺术生的特性及学习习惯。教师工资考核与学生成绩挂钩，认真负责，全程跟进。</p><p style=\"word-wrap: break-word; outline: none; margin: auto; padding: 0px; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\">2.本机构全年招生，教学方法不断改进，学生数量多，教师经验不断积累，教学方法不断更新。</p><p style=\"word-wrap: break-word; outline: none; margin: auto; padding: 0px; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\">3.模块化教学，互动式教学，帮助学生提高学习兴趣，完全掌握基本知识点并在考试中自主应用。</p><p style=\"word-wrap: break-word; outline: none; margin: auto; padding: 0px; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\">4。本机构对学生的不同程度进行分班，教师对应不同程度的学生有不用的教学方法。</p><hr style=\"word-wrap: break-word; outline: none; border-bottom-style: dotted; border-bottom-color: rgb(204, 204, 204); border-top-width: 0px; margin: 30px auto; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\"/><p style=\"word-wrap: break-word; outline: none; margin: auto auto 24px; padding: 0px; font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; white-space: normal; font-size: 32px; color: rgb(68, 68, 68); background-color: rgb(255, 255, 255);\">与在校生的区别</p><p style=\"word-wrap: break-word; outline: none; margin: auto auto 24px; padding: 0px; font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; white-space: normal; font-size: 12px; color: rgb(143, 143, 143); background-color: rgb(255, 255, 255);\">The difference</p><p style=\"word-wrap: break-word; outline: none; margin: auto; padding: 0px; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\">1.学校进度较快，艺考生长期不在学校，跟不上进度。</p><p style=\"word-wrap: break-word; outline: none; margin: auto; padding: 0px; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\">2.学校不开设专门对艺考生的班级，学校教学方法不适合艺考生，高三下学期基本忽略基础知识点，艺术生难以达到目标分数。</p><p style=\"word-wrap: break-word; outline: none; margin: auto; padding: 0px; color: rgb(106, 106, 106); font-family: &quot;Microsoft YaHei&quot;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; background-color: rgb(255, 255, 255);\">3.有开设艺考生班级的学校，无对学生程度进行区分，不利于个人成绩的提升。</p><p><br/></p>','1','1');
INSERT INTO `xyh_category` VALUES ('2','新闻中心','xinwenzhongxin','','0','1','0','新闻中心','','','','List_article.html','Show_article.html','','0','2');
...
INSERT INTO `xyh_category` VALUES ('5','产品展示','chanpinzhanshi','','0','3','0','产品展示','','','','List_product.html','Show_product.html','','0','3');
...
INSERT INTO `xyh_category` VALUES ('8','公司相册','gongsixiangce','','0','4','0','公司相册','','','','List_picture.html','Show_picture.html','','0','5');
INSERT INTO `xyh_category` VALUES ('9','在线留言','@guestbook/index','','0','0','1','','','','','List_article.html','Show_article.html','','0','6');
INSERT INTO `xyh_category` VALUES ('10','联系我们','lianxiwomen','','0','2','0','联系我们','','','','List_contact.html','Show_jobs.html','<p>欢迎光临！</p><p>&nbsp;</p><p>公司地址：云南省昆明市北京路299<br/>&nbsp;</p><p>公司电话：0871-100000</p><p>售前咨询客服QQ-01：<br/>售前咨询客服QQ-02：<br/>客户售前咨询热线：<br/>客户售后服务热线：<br/>客服信箱：</p><p>&nbsp;</p><p>&nbsp;</p>','1','7');
INSERT INTO `xyh_category` VALUES ('12','服务介绍','service','','0','2','0','','','A晚间作业辅导1 每周一到五，19:00-22:00  进行作业辅导；2 配置专业教师团队坐镇答疑室，及时解惑，提高学习效率；3 提供最舒适的学习环境，采取监控式管理，保障晚辅纪律；B毕业班辅导课程1 按专题授课，自主选','','List_service.html','Show_jobs.html','<ul class=\" list-paddingleft-2\"><li><div class=\"service_L fl\">A</div><div class=\"service_R fl\"><h2>晚间作业辅导</h2><div class=\"clear service_R_down\">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;\r\n									1 每周一到五，19:00-22:00&nbsp;&nbsp;进行作业辅导；2 配置专业教师团队坐镇答疑室，及时解惑，提高学习效率；3 提供最舒适的学习环境，采取监控式管理，保障晚辅纪律；</div></div></li><li><div class=\"service_L fl\">B</div><div class=\"service_R fl\"><h2>毕业班辅导课程</h2><div class=\"clear service_R_down\">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;\r\n									1 按专题授课，自主选报，每六周一专题；2 采用知识讲解与典例解析课组结合的循环授课模式；3 对基础较弱的学生，建议增加额外小班；</div></div></li><li><div class=\"service_L fl\">C</div><div class=\"service_R fl\"><h2>非毕业班辅导课程</h2><div class=\"clear service_R_down\">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;\r\n									1 精致小班，按层次分班教学；2 与学校同步，即时解决学生在校疑点；3 及时反馈学生学习情况，保障学习效果；</div></div></li><li><div class=\"service_L fl\">D</div><div class=\"service_R fl\"><h2>“私人定制”课程</h2><div class=\"clear service_R_down\">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;\r\n									1 名师授课，配置最符合学生实际情况的教师；2 为学生量身定制学习方案；3 针对性备课辅导，快速解决学生知识短板;</div></div></li></ul>','1','1');
INSERT INTO `xyh_category` VALUES ('13','招聘信息','zhaopinxinxi','','0','1','0','','','','','List_jobs.html','Show_jobs.html','','1','1');
INSERT INTO `xyh_category` VALUES ('14','近期活动','jinqihuodong','','0','1','0','','','','','List_news.html','Show_news.html','','1','1');
INSERT INTO `xyh_category` VALUES ('15','代言人','daiyanren','','0','4','0','','','','','','','','0','1');
...
# 转存表中的数据：xyh_config 
INSERT INTO `xyh_config` VALUES ('1','CFG_WEBNAME','网站名称','','','2','1','思行教育机构','0');
INSERT INTO `xyh_config` VALUES ('2','CFG_WEBURL','网站域名','','','2','1','http://sixing.cc','0');
INSERT INTO `xyh_config` VALUES ('3','CFG_WEBTITLE','网站标题','站点首页title(SEO)的设置','','2','1','思行教育机构','0');
INSERT INTO `xyh_config` VALUES ('4','CFG_KEYWORDS','站点关键词','','','2','1','思行教育机构','0');
INSERT INTO `xyh_config` VALUES ('5','CFG_DESCRIPTION','站点描述','','','3','1','思行教育机构','0');
INSERT INTO `xyh_config` VALUES ('6','CFG_THEMESTYLE','模板风格','','select','2','1','Tmp1','0');
INSERT INTO `xyh_config` VALUES ('7','CFG_COOKIE_ENCODE','cookie加密码','','','2','1','4NiTYt19L','0');
INSERT INTO `xyh_config` VALUES ('8','CFG_POWERBY','网站版权信息','','','3','1','©2010-2016 www.sixingjiaoyu.com All Rights Reserved 思行教育机构 粤ICP备1234567号-1','0');
INSERT INTO `xyh_config` VALUES ('9','CFG_STATS','网站统计','','','3','1','','0');
INSERT INTO `xyh_config` VALUES ('10','CFG_BEIAN','网站备案号','','','2','1','','0');
INSERT INTO `xyh_config` VALUES ('11','CFG_ADDRESS','联系地址','','','2','1','汕头市金平区中山路81号(四中，一中对面)','0');
INSERT INTO `xyh_config` VALUES ('12','CFG_PHONE','联系电话','','','2','1','0754-83922234 　 0754-88564523','0');
...
INSERT INTO `xyh_config` VALUES ('41','CFG_QQ','QQ号码','','','2','1','550771958','0');
...
# 转存表中的数据：xyh_meta 
INSERT INTO `xyh_meta` VALUES ('1','1','HOME_URL_MODEL','1');
...
INSERT INTO `xyh_meta` VALUES ('21','9','ONLINE_CFG_QQ','11111$$$点击咨询\r\n11111$$$点击留言');
INSERT INTO `xyh_meta` VALUES ('22','9','ONLINE_CFG_WANGWANG','');
INSERT INTO `xyh_meta` VALUES ('23','9','ONLINE_CFG_PHONE_ON','0');
INSERT INTO `xyh_meta` VALUES ('24','9','ONLINE_CFG_PHONE','');
...
INSERT INTO `xyh_picture` VALUES ('2','翁婕菀','','','/uploads/img1/20160906/57ced6c6bd4de.jpg!300X300.jpg','2016年3月份一模成绩310， 经过3个月思考行教育艺术考生全日制培训班。高考成绩460分，最终被星海音乐学院录取。拿到录取通知书时候，他妈妈特意和思行教育的老师打了一通电话，翁妈妈说：孩子考上星海真的很不容易，我的孩子很幸运。一模成绩出来后，决定给他报了一对一的课程，得到老师给他辅导功课。他最弱的语文和英语，两门功课提高了能有50多分。','','','/uploads/img1/20160906/57ced6c6bd4de.jpg$$$$$$','<p><span style=\"color: rgb(102, 102, 102); font-family: &#39;Microsoft YaHei&#39;, Arial, Helvetica, sans-serif; font-size: 12px; background-color: rgb(255, 255, 255);\">2016年3月份一模成绩310， 经过3个月思考行教育艺术考生全日制培训班。高考成绩460分，最终被星海音乐学院录取。拿到录取通知书时候，他妈妈特意和思行教育的老师打了一通电话，翁妈妈说：孩子考上星海真的很不容易，我的孩子很幸运。一模成绩出来后，决定给他报了一对一的课程，得到老师给他辅导功课。他最弱的语文和英语，两门功课提高了能有50多分。</span></p>','1473173161','1473173205','15','15','0','3','','0','0','1');
INSERT INTO `xyh_picture` VALUES ('3','许玺铎','','','/uploads/img1/20160906/57ced84020a9d.jpg!300X300.jpg','2016年3月份一模成绩148， 经过3个月思考行教育艺术考生全日制培训班。高考成绩325分。来自澄海的学生，和他同学一起。当时他的分数已经是全班倒数，对学习也信心全无。特别是在数学方面，语文作文得分几乎全无。经过思行老师的精心辅导，他的成绩虽然没有达到很高的分数，但是对于考试中怎么样拿下可以得到的分数以及快速地提分，他的考试技巧有了长足的进步。最后考出自己想要的分数。','','','/uploads/img1/20160906/57ced84020a9d.jpg$$$$$$','<p><span style=\"color: rgb(102, 102, 102); font-family: &#39;Microsoft YaHei&#39;, Arial, Helvetica, sans-serif; font-size: 12px; background-color: rgb(255, 255, 255);\">2016年3月份一模成绩148， 经过3个月思考行教育艺术考生全日制培训班。高考成绩325分。来自澄海的学生，和他同学一起。当时他的分数已经是全班倒数，对学习也信心全无。特别是在数学方面，语文作文得分几乎全无。经过思行老师的精心辅导，他的成绩虽然没有达到很高的分数，但是对于考试中怎么样拿下可以得到的分数以及快速地提分，他的考试技巧有了长足的进步。最后考出自己想要的分数。</span></p>','1473173561','1473173578','86','15','1','1','','1','0','1');
INSERT INTO `xyh_picture` VALUES ('4','许玺铎','','','/uploads/img1/20160906/57ced84020a9d.jpg!300X300.jpg','2016年3月份一模成绩148， 经过3个月思考行教育艺术考生全日制培训班。高考成绩325分。来自澄海的学生，和他同学一起。当时他的分数已经是全班倒数，对学习也信心全无。特别是在数学方面，语文作文得分几乎全无。经过思行老师的精心辅导，他的成绩虽然没有达到很高的分数，但是对于考试中怎么样拿下可以得到的分数以及快速地提分，他的考试技巧有了长足的进步。最后考出自己想要的分数。','','','/uploads/img1/20160906/57ced84020a9d.jpg$$$$$$','<p><span style=\"color: rgb(102, 102, 102); font-family: &#39;Microsoft YaHei&#39;, Arial, Helvetica, sans-serif; font-size: 12px; background-color: rgb(255, 255, 255);\">2016年3月份一模成绩148， 经过3个月思考行教育艺术考生全日制培训班。高考成绩325分。来自澄海的学生，和他同学一起。当时他的分数已经是全班倒数，对学习也信心全无。特别是在数学方面，语文作文得分几乎全无。经过思行老师的精心辅导，他的成绩虽然没有达到很高的分数，但是对于考试中怎么样拿下可以得到的分数以及快速地提分，他的考试技巧有了长足的进步。最后考出自己想要的分数。</span></p>','1473173561','1473173578','34','15','1','1','','0','0','1');
INSERT INTO `xyh_picture` VALUES ('5','陈诗敏','','','/uploads/img1/20160906/57ced8676f1a6.jpg!300X300.jpg','陈诗敏在思行赫赫有名，因为她是目前思行一个学期单科提分记录的保持着。高三上学期短短的三个月数学单科成绩从90分提升到130分。用她自己的话说，思行的老师帮她通了任督二脉，把她从初中到高中，数学不适用的混乱状态拯救出来，找到高中数学的学习方法之后，考试分数一发不可收拾。','','','/uploads/img1/20160906/57ced8676f1a6.jpg$$$$$$','<p><span style=\"color: rgb(102, 102, 102); font-family: &#39;Microsoft YaHei&#39;, Arial, Helvetica, sans-serif; font-size: 12px; background-color: rgb(255, 255, 255);\">陈诗敏在思行赫赫有名，因为她是目前思行一个学期单科提分记录的保持着。高三上学期短短的三个月数学单科成绩从90分提升到130分。用她自己的话说，思行的老师帮她通了任督二脉，把她从初中到高中，数学不适用的混乱状态拯救出来，找到高中数学的学习方法之后，考试分数一发不可收拾。</span></p>','1473173597','1473173609','59','15','1','1','','0','0','1');
